...
urlpatterns = [
    ...
    path("<int:pk>/livre-dor/", views.guestbook_messages, name="guestbook_messages"),
    path(
        "<int:pk>/livre-dor/montage/",
        views.generate_guestbook_movie,
    ...
    path("<int:pk>/qr-a-imprimer/", views.qr_print_sheet, name="qr_print_sheet"),
    path("<int:pk>/stats-live/", views.live_stats_panel, name="live_stats"),
    path("<int:pk>/film/", views.movie_ready_detail, name="movie_ready"),
